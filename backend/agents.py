...
class ResearchAgents():
    ...
    def __init__(self):
        # Validar que SERPER_API_KEY esté configurada
        serper_api_key = os.getenv("SERPER_API_KEY")
        if not serper_api_key:
            raise ValueError(
                "SERPER_API_KEY no está configurada. "
                "Por favor, configura la variable de entorno SERPER_API_KEY. "
                "Puedes obtener una clave en https://serper.dev"
            )
